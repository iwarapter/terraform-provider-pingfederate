		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					requiredVersionTestCheckFunc(11, 1, resource.TestCheckResourceAttr(datasourceName, "activation_code_check_mode", "AFTER_AUTHENTICATION")),
					...
					requiredVersionTestCheckFunc(11, 1, resource.TestCheckResourceAttr(datasourceName, "client_secret_retention_period", "0")),
					...
					requiredVersionTestCheckFunc(10, 3, resource.TestCheckResourceAttr(datasourceName, "disallow_plain_pkce", "false")),
					requiredVersionTestCheckFunc(11, 0, resource.TestCheckResourceAttr(datasourceName, "include_issuer_in_authorization_response", "false")),
					requiredVersionTestCheckFunc(11, 1, resource.TestCheckResourceAttr(datasourceName, "jwt_secured_authorization_response_mode_lifetime", "600")),
					...
					requiredVersionTestCheckFunc(11, 0, resource.TestCheckResourceAttr(datasourceName, "refresh_token_rolling_grace_period", "0")),
