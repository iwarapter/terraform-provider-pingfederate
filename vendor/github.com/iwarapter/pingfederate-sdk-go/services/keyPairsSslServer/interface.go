...
type KeyPairsSslServerAPI interface {
	...
	GetSettings() (output *models.SslServerSettings, resp *http.Response, err error)
	GetSettingsWithContext(ctx context.Context) (output *models.SslServerSettings, resp *http.Response, err error)

	UpdateSettings(input *UpdateSettingsInput) (output *models.SslServerSettings, resp *http.Response, err error)
	UpdateSettingsWithContext(ctx context.Context, input *UpdateSettingsInput) (output *models.SslServerSettings, resp *http.Response, err error)
}
