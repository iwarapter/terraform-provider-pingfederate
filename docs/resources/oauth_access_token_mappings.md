...
page_title: "pingfederate_oauth_access_token_mappings Resource - terraform-provider-pingfederate"
subcategory: ""
description: |-
  Provides configuration for OAuth Access Token Mappings within PingFederate.
---

# pingfederate_oauth_access_token_mappings (Resource)
...
- `access_token_manager_ref` (Block List, Min: 1, Max: 1) Reference to the access token manager this mapping is associated with. This property cannot be changed after the mapping is created. (see [below for nested schema](#nestedblock--access_token_manager_ref))
...
- `context` (Block List, Min: 1, Max: 1) The context of the Access Token Mapping. This property cannot be changed after the mapping is created. (see [below for nested schema](#nestedblock--context))
...
- `context_ref` (Block List, Max: 1) Reference to the associated Access Token Mapping Context instance. (see [below for nested schema](#nestedblock--context--context_ref))

<a id="nestedblock--context--context_ref"></a>
