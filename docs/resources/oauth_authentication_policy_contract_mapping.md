...
subcategory: ""
description: |-
  Provides configuration for OAuth Authentication Policy Contract Mappings within PingFederate.
---
...
- `authentication_policy_contract_ref` (Block List, Min: 1, Max: 1) Reference to the associated authentication policy contract. The reference cannot be changed after the mapping has been created. (see [below for nested schema](#nestedblock--authentication_policy_contract_ref))
...
<a id="nestedblock--authentication_policy_contract_ref"></a>
